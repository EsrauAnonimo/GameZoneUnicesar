...
/**
 * Represents a client of the store, i.e. a person who buys products.
 * <p>
 ...
 * that reference this client's id. Keeping it out of Client avoids coupling
...
public class Client extends Person {
     ...
     */
    public Client(String id, String name, String identification, String phone, String email) {
    ...
    public String getRoleDescription() {
        ...
        return "Role: Client | Email: " + email;
    }
}
